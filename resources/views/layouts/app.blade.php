            ...
            <div class="sidebar text-center bg-gray-900">
                <div class="text-gray-100 text-xl">
                    <div class="p-2.5 mt-1 flex items-center">
                        ...
                        <h1 class="font-bold text-gray-200 text-[15px] ml-3">SkillUp</h1>
                    </div>
                ...
                <a href="{{ route('employee.courses') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                        <i class="bi bi-book-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Courses</span>
                    </div>
                </a>
                <a href="{{ route('employee.attendance') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                        <i class="bi bi-calendar-check-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Attendance</span>
                    </div>
                </a>
