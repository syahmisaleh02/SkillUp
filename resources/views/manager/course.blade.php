                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div class="flex justify-end space-x-2">
                                <a href="{{ route('manager.course.edit', ['id' => 1]) }}" class="text-blue-500 hover:text-blue-700">
                        ...
                        <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-2">Web Development Fundamentals</h3>
                        <p class="text-gray-600 dark:text-gray-300 mb-4">Learn the basics of web development including HTML, CSS, and JavaScript.</p>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <i class="fas fa-users text-gray-500 dark:text-gray-400 mr-2"></i>
                                <span class="text-sm text-gray-500 dark:text-gray-400">24 Enrolled</span>
                            </div>
                            <div class="flex items-center">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div class="flex justify-end space-x-2">
                                <a href="{{ route('manager.course.edit', ['id' => 2]) }}" class="text-blue-500 hover:text-blue-700">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <button type="button" class="text-red-500 hover:text-red-700">
                                    <i class="fas fa-trash"></i>
                        ...
                        <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-2">Advanced UI/UX Design</h3>
                        <p class="text-gray-600 dark:text-gray-300 mb-4">Master the principles of user interface and experience design.</p>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <i class="fas fa-users text-gray-500 dark:text-gray-400 mr-2"></i>
                                <span class="text-sm text-gray-500 dark:text-gray-400">0 Enrolled</span>
                            </div>
                            <div class="flex items-center">
                                <i class="fas fa-star text-yellow-500 mr-1"></i>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div class="flex justify-end space-x-2">
                                <a href="{{ route('manager.course.edit', ['id' => 3]) }}" class="text-blue-500 hover:text-blue-700">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <button type="button" class="text-red-500 hover:text-red-700">
                                    <i class="fas fa-trash"></i>
                        ...
                        <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-2">Project Management Essentials</h3>
                        <p class="text-gray-600 dark:text-gray-300 mb-4">Learn the fundamentals of project management and team leadership.</p>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <i class="fas fa-users text-gray-500 dark:text-gray-400 mr-2"></i>
                                <span class="text-sm text-gray-500 dark:text-gray-400">18 Enrolled</span>
                            </div>
                            <div class="flex items-center">
                                <i class="fas fa-star text-yellow-500 mr-1"></i>
